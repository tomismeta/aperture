...
export function printReviewCandidateUsage(): void {
  process.stdout.write(
    [
      ...
      "",
      "Extracts deterministic semantic and judgment review candidates from replay bundles or canonical F-Stop sessions.",
      "",
      "Options:",
      "  --manifest <path>             Public corpus run manifest JSON to scan through its verified ledger (repeatable)",
      "  --bundle <path>               Replay bundle or canonical F-Stop session JSON to scan (repeatable)",
      "  --bundle-dir <path>           Directory of replay bundles or canonical F-Stop sessions to scan recursively (repeatable)",
...
export function printCorpusRunUsage(): void {
  process.stdout.write(
    [
      ...
      "",
      "Runs a bounded public corpus import and writes an auditable manifest/report.",
      "",
      "Options:",
      "  --dataset <dataclaw|trace-commons>  Public dataset to import (default: trace-commons)",
      ...
      "  --page-size <number>            Rows per request, max 100 (default: 25 trace-commons, 1 dataclaw)",
