...
For the current shipped release summary, see [Aperture Core SDK v0.5.0](https://github.com/tomismeta/aperture/blob/main/docs/releases/aperture-core-v0.5.0.md).
