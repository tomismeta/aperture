...
Replay, scorecard, and benchmark scaffolding for Aperture.

This package is the first implementation surface behind **ApertureBench**.
...
For the broader benchmark architecture, see
[ApertureBench](../../docs/engine/aperture-bench.md).
