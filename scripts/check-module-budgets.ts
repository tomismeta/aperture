...
const budgets = [
  ...
  { file: "packages/runtime/src/runtime-surface-routes.ts", maxLines: 175 },
  ...
  { file: "packages/runtime/src/runtime-client-subscriptions.ts", maxLines: 100 },
  ...
  { file: "packages/aperture/src/omp-attention-event.ts", maxLines: 325 },
  { file: "packages/aperture/src/notification-worker/direct-server.ts", maxLines: 300 },
  { file: "packages/aperture/src/notification-worker/engine.ts", maxLines: 500 },
  { file: "packages/aperture/src/notification-worker/omp-direct-adapter.ts", maxLines: 225 },
  { file: "packages/aperture/src/notification-worker/omp-direct-state-store.ts", maxLines: 375 },
  { file: "packages/omp/src/direct-event-mapping.ts", maxLines: 250 },
  { file: "packages/omp/src/direct-worker-transport.ts", maxLines: 175 },
  { file: "packages/omp/src/omarchy-attention-transport.ts", maxLines: 125 },
